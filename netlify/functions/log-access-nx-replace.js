...
const LOG_FILE_PATH = 'logs/nx-replace.log';
...
export async function handler(event) {
  try {
	...
	if (bodyData.clientVersion) clientVersion = bodyData.clientVersion;
      } catch (e) {
    ...
    const logLine = `${accessTime} - PublicIP: ${publicIp}, PrivateIP: ${privateIp} - ClientVersion: ${clientVersion}, CurrentVersion: ${CURRENT_VERSION} \n`;
